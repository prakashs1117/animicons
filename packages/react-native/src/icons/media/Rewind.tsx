...
import { RewindPaths } from '@animicons/shared';
...
export const Rewind: React.FC<IconProps> = ({
  ...
  return (
    <Svg width={size} height={size} viewBox={RewindPaths.viewBox} style={style as any}>
      <AnimatedPath animatedProps={chev1Props} d={RewindPaths.chev1} stroke={s.stroke} strokeWidth={s.strokeWidth} strokeLinecap="round" strokeLinejoin="round" fill="none" opacity={s.opacity} />
      <AnimatedPath animatedProps={chev2Props} d={RewindPaths.chev2} stroke={s.stroke} strokeWidth={s.strokeWidth} strokeLinecap="round" strokeLinejoin="round" fill="none" opacity={s.opacity} />
      <Path d={RewindPaths.end} stroke={s.stroke} strokeWidth={s.strokeWidth} strokeLinecap="round" fill="none" opacity={s.opacity} />
    </Svg>
  );
};
